...
public class FanOutQueue3Handler : IQueueHandler
{
    private readonly RabbitMqSettings _rabbitSettings;
    private readonly IModel _channel;
    private readonly ILogger<FanOutQueue3Handler> _logger;

    public FanOutQueue3Handler(RabbitMqSettings rabbitSettings, IModel channel, ILogger<FanOutQueue3Handler> logger)
    {
    ...
    public string ApplicableQueue => RabbitMqQueues.FanOutQueue3;
    ...
    private async Task Consumer_Received(object sender, BasicDeliverEventArgs ea)
    {
        ...
        _logger.LogInformation($"Fan Out 3 Message Received: {product}");
